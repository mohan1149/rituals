...
<section class="content">
                ...
                <div class="box-body">
                    <div class="row">
                         <div class="col-lg-4">
                            ...
                            {!! Form::text('outside_order_list_filter_date_range', null, ['placeholder' => __('lang_v1.select_a_date_range'), 'class' => 'form-control bookings_list_filter_date_range', 'readonly']); !!}
                        </div>
                        <div class="col-lg-4">
    ...
    <!--edit modal-->
    <div class="modal fade edit_booking" tabindex="-1" role="dialog" 
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.bookings_list_filter_date_range').daterangepicker(
                dateRangeSettings,
                function (start, end) {
                    $('.bookings_list_filter_date_range').val(start.format(moment_date_format) + ' ~ ' + end.format(moment_date_format));
                        todays_bookings_table.ajax.reload();
                }
            );
            todays_bookings_table = $('#todays_bookings_table').DataTable({
                            ...
                            "ajax": {
                                ...
                                "data": function ( d ) {
                                    var start = $('.bookings_list_filter_date_range').data('daterangepicker').startDate.format('YYYY-MM-DD');
                                    var end = $('.bookings_list_filter_date_range').data('daterangepicker').endDate.format('YYYY-MM-DD');
